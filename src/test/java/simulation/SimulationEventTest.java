...
public class SimulationEventTest extends TestCase{
	...
	public void testGetDescription() {
		try {
			SimulationTaskEvent se = new SimulationTaskEvent("simulation event test", 0, "processId");
	...
	public void testCompareTo() {
		try {
			SimulationTaskEvent se1 = new SimulationTaskEvent("simulation event test 1", 10, "processId");
			SimulationTaskEvent se2 = new SimulationTaskEvent("simulation event test 2", 11, "processId");
