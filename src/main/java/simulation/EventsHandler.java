...
public class EventsHandler {
	...
	public void addBoundaryEvent(String eventName, long time, String processInstanceId, long startTime) {
		SimulationEvent simEvnt = new SimulationBoundaryEvent(eventName, time, processInstanceId, startTime);
		eventsQueue.add(simEvnt);
	}
